...
Even if you don't _need_ additional upper arm protection, a big hit to the shoulder can be uncomfortable, so these are still worth consideration.

_(See also [forearms and elbows](/articles/protection/forearms-and-elbows/).)_
...
MAC sells a fairly premium set of [shoulder protectors](https://www.mac-armour.cz/p/shoulder-protector). Most hard protectors are fairly plain, so these will stand out.

### North Armoury

North Armoury has a new [whitelabel shoulder guard](https://northarmoury.ca/na-hema-shoulder-guard/) that articulates well while providing better coverage than the SPES PRO Set. These require arming straps, and because they are held together with elastic paracord, you should definitely have some spare material for repairs.
