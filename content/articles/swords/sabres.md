...
The [Krieger S6](https://kriegerweapons.com/products/hema/s6-hema-sabre/) is an underrated full-curve sabre. Not as flashy as other options, it nevertheless has good presence and balance as a middleweight sabre. Although the grip's texture can feel a bit strange on a bare hand, it this same texture keeps it from slipping when in a gloved hand.
...
Cupped regenyei sabres come in three versions: the [Tournament](https://regenyei.com/product/torunament-saber/), the [Light](https://regenyei.com/product/light-saber/), and the [Duelist](https://regenyei.com/product/duelist-saber/). The Tournament and Light are tournament legal with local organizers (though it's a close thing with the Light if its weight varies more than advertised) whereas the Duelist is not.

All blades would be considered partial curve.

## Sigi Forge | 🇸🇰

Unfortunately Sigi's best sabre, the Sabre PRO, isn't available at the moment, but there are other good options. The Sigi [Sabre Big](https://sigiforge.com/products/sigi-saber-big/) is a cuphilt sabre with enough room to accommodate a truly enormous glove. You could even fit a clamshell in there, though it's not recommended.
